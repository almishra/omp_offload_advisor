...
{
#pragma omp target \
  map(chi_p[0:LT][0:LZ][0:LY][0:LX/2][0:4][0:3][0:2]) \
  map(u_p_f_tst[0:2][0:LT+1][0:LZ+1][0:LY+1][0:LX/2+1][0:4][0:3][0:3][0:2]) \
  map(psi_p_f_tst[0:LT+2][0:LZ+2][0:LY+2][0:LX/2+2][0:4][0:3][0:2])
