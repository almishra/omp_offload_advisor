...
#pragma omp target enter data map(                                             \
    to                                                                         \
    : chi_p [0:48] [0:16] [0:16] [0:32] [0:4] [0:3] [0:2],                     \
      u_p_f_tst [0:2] [0:49] [0:17] [0:17] [0:33] [0:4] [0:3] [0:3] [0:2],     \
      psi_p_f_tst [0:50] [0:18] [0:18] [0:34] [0:4] [0:3] [0:2])
...
#pragma omp parallel for schedule(dynamic)
  ...
  fprintf(fp, "wilson_dslash_kernel_parPos4_distCol2_parCol1_dynamic,%ld\n",
          (end - start));
