...
#pragma omp target enter data map(                                             \
    to                                                                         \
    : chi_p [0:32] [0:48] [0:48] [0:32] [0:4] [0:3] [0:2],                     \
      u_p_f_tst [0:2] [0:33] [0:49] [0:49] [0:33] [0:4] [0:3] [0:3] [0:2],     \
      psi_p_f_tst [0:34] [0:50] [0:50] [0:34] [0:4] [0:3] [0:2])
...
#pragma omp target teams distribute parallel for collapse(4) schedule(dynamic)
  ...
  fprintf(fp, "wilson_dslash_kernel_parPos2_distCol1_parCol4_dynamic,%ld\n",
          (end - start));
