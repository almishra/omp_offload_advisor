...
#pragma omp target enter data map(to: chi_p[0:16][0:32][0:16][0:16][0:4][0:3][0:2], u_p_f_tst[0:2][0:17][0:33][0:17][0:17][0:4][0:3][0:3][0:2], psi_p_f_tst[0:18][0:34][0:18][0:18][0:4][0:3][0:2])
...
#pragma omp target exit data map(from: chi_p[0:16][0:32][0:16][0:16][0:4][0:3][0:2], u_p_f_tst[0:2][0:17][0:33][0:17][0:17][0:4][0:3][0:3][0:2], psi_p_f_tst[0:18][0:34][0:18][0:18][0:4][0:3][0:2])
gettimeofday(&tv2, NULL);
long end = (tv2.tv_sec*1000000 + tv2.tv_usec);
fprintf(fp,"wilson_dslash_kernel_parPos2_distCol1_parCol2_dynamic_memcpy,%ld\n",  (end - start));
 // end x loop
}
