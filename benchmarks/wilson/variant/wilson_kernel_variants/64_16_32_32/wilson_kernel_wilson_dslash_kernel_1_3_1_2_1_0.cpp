...
#pragma omp target enter data map(                                             \
    to                                                                         \
    : chi_p [0:32] [0:32] [0:16] [0:32] [0:4] [0:3] [0:2],                     \
      u_p_f_tst [0:2] [0:33] [0:33] [0:17] [0:33] [0:4] [0:3] [0:3] [0:2],     \
      psi_p_f_tst [0:34] [0:34] [0:18] [0:34] [0:4] [0:3] [0:2])
...
#pragma omp parallel for collapse(2) schedule(dynamic)
  ...
  fprintf(fp, "wilson_dslash_kernel_parPos3_distCol1_parCol2_dynamic,%ld\n",
          (end - start));
